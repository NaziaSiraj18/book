...
const config = {
  ...
  tagline: 'An in-depth guide to building intelligent physical systems and humanoid robots',
  favicon: 'Start My Journey',
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/chapter1-basics-of-physical-ai',
              },
              {
                label: 'Humanoid Robotics',
                to: '/docs/chapter2-introduction-to-humanoid-robotics',
              },
              {
                label: 'Sensorimotor Learning',
                to: '/docs/chapter3-sensorimotor-learning-in-robots',
              },
            ],
          },
          {
